...
var Thumb = function (_Component) {
  ...
  function Thumb() {
    ...
    return _ret = (_temp = (_this = (0, _possibleConstructorReturn3['default'])(this, _Component.call.apply(_Component, [this].concat(args))), _this), _this.getDefaultThumb = function () {
      var children = [];
